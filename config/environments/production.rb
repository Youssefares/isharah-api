Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "egsl-website-api_#{Rails.env}"
  ...
  # TODO: fix this when we go to broad
  config.action_mailer.default_url_options = { host: 'isharah.com', port: 8888 }
